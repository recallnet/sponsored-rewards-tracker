  ...
  return (
    <>
      ...
      <div className="overflow-x-auto border border-[#333]">
              ...
              return (
                <Fragment key={s.slug}>
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right font-mono">
                      {formatCompact(s.volume24hr)}
                    </td>
                    <td className="py-3 px-4 text-right font-mono">
                      {formatCompact(s.liquidity)}
                    </td>
                    <td className="py-3 px-4 text-right font-mono">
                      {formatCompact(s.estimatedDailyRebates)}/d
                    </td>
        ...
        {series.length === 0 && (
          <p className="text-center text-[#555] py-8 text-sm">
            No eligible maker rebate series found.
          </p>
        )}
      </div>
